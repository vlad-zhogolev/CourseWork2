...
// directional lights
std::shared_ptr<vector<DirectionalLight>> dirLights = std::make_shared<std::vector<DirectionalLight>>();
// point lights
std::shared_ptr<vector<PointLight>> pointLights = std::make_shared<std::vector<PointLight>>();
// spot lights
std::shared_ptr<vector<SpotLight>> spotLights = std::make_shared<std::vector<SpotLight>>();
// objects
